...
public class runde {
    ...
    public char ergebnis() {
        ...
        if (    (spielerSymbol.equals("Schere") && computerSymbol.equals("Papier"))
                ||
                (spielerSymbol.equals("Papier") && (computerSymbol.equals("Brunnen") || computerSymbol.equals("Stein")))
                ||
                (spielerSymbol.equals("Stein") && computerSymbol.equals("Schere"))
                ||
                (spielerSymbol.equals("Brunnen") && (computerSymbol.equals("Stein") || computerSymbol.equals("Schere")))
        )
        {
